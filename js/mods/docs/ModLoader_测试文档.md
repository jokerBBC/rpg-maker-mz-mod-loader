...
| Q9 | 默认勾选「不更新文档」→ 更新 | 跳过 `docs/` 除更新日志外文件；日志仍更新 `docs/modloader_CHANGELOG.md` | |
| Q10 | 仅文档有差异 + 默认勾选 | 检查结果为「已是最新」（不因文档打扰） | |
| Q11 | 取消勾选「不更新文档」→ 更新 | 文档随更新一并下载替换 | |
| Q12 | 勾选时 catalog `remove` 含 docs | 不清理本地文档；取消勾选后才会清理 | |
...
| 日期 | 说明 |
| --- | --- |
| 2026-09-24 | V4.4.7：§Q 新增 Q9–Q12 文档默认不更新 |
