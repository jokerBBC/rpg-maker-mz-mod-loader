...
| [ModLoader_模块结构.md](ModLoader_模块结构.md) | Maintainer map: where changes go, how to test, boundaries |
| [调用规范.md](前置Mod相关文档/调用规范.md) | Prerequisite mod usage spec (data + resources) |
