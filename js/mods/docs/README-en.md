...
| [调用规范.md](前置Mod相关文档/调用规范.md) | Prerequisite mod usage spec (data + resources; required for mod authors) |
| [数据和资源前置Mod-V2-需求规格书.md](前置Mod相关文档/数据和资源前置Mod-V2-需求规格书.md) | Prerequisite mod V2 architecture, API, and MVP spec |
| [前置Mod测试清单.md](前置Mod相关文档/前置Mod测试清单.md) | Prerequisite mod test checklist (some cases passed) |
